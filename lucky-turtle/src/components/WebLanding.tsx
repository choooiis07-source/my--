...
const copy = {
  ko: {
    ...
    features: [
      ...
      ['손길을 기억하는 감정', '한 번은 눈웃음, 자꾸 건드리면 화난 눈. 다섯 번째에는 몸을 쏙 숨겨요.', '02'],
      ['오늘의 기분을 닮은 컬러', '차분한 초록부터 선명한 코랄까지. 오늘의 거북이 컬러와 움직임 속도를 내 기분에 맞게 고르세요.', '03'],
    ],
    ...
    touch: '거북이 만지기',
    touchCount: '번의 손길',
    moodLabels: ['산책 중', '반가워!', '조금 귀찮아', '화났어!', '슬퍼…', '쏙 숨기'],
  ...
  en: {
    ...
    features: [
      ...
      ['It remembers every touch', 'One touch brings a smile. Keep poking and it gets upset. On the fifth, it hides away.', '02'],
      ['A color for today’s mood', 'From calm green to vivid coral, choose a turtle color and walking pace that feels like you.', '03'],
    ],
    demoEyebrow: '03 / TOUCH & FEEL',
    ...
    touchCount: 'touches',
    moodLabels: ['Just strolling', 'Good to see you!', 'A little annoyed', 'Now I’m mad!', 'That hurt…', 'Hiding away'],
